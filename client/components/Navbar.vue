<template>
    ...
    <div class="flex md:order-2">
        ...
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <NuxtLink to="/"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-violet-500 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                        :class="{ 'md:text-blue-500': isActive('') }">
                        Главная</NuxtLink>
                </li>
                <li>
                    <NuxtLink to="/blog"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-violet-500 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                        :class="{ 'md:text-blue-500': isActive('blog') || isActive('post') || isActive('gategory') }">Блог</NuxtLink>
                </li>
                <li>
                    <NuxtLink to="/contact"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-violet-500 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                        :class="{ 'md:text-blue-500': isActive('contact') }" >
                        Контакты</NuxtLink>
                </li>
            </ul>
        </div>
...
useHead({
    ...
    script: [
        {
            src:'https://cdn.jsdevir.net/npm/flowbite@2.5.2/dist/flowbite.min.js',
            async: true,
            defer: true
        }
    ]
