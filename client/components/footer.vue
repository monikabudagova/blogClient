    ...
    <div class="mx-auto w-full py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="http://localhost:3000/" class="flex items-center">
                  <img src="https://4ccc2241e457.vps.myjino.ru/uploads/free_icon_music_note_1816908_7084764faf.svg" class="h-8 me-3" alt="FlowBite Logo" />
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://github.com/monikabudagova" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
