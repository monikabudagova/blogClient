<template>
  <main>
    ...
    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Каждая <mark class="px-2 text-white bg-blue-600 rounded-sm dark:bg-blue-500">звезда</mark> — это история.</h1>
    <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Давайте узнаем их тайны.</p>
