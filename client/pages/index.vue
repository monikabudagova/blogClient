<template>
  <main>
    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Каждая <mark class="px-2 text-white bg-pink-500 rounded-sm dark:bg-violet-600">звезда</mark> — это история.</h1>
