<template>
  <main class="w-full">
    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white font-sans animate__animated animate__fadeIn">
      Каждая <mark class="px-2 text-white bg-violet-500 rounded-sm dark:bg-violet-600">звезда</mark> — это история.
    </h1>
    <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 font-sans animate__animated animate__fadeIn animate__delay-1s">
      Давайте узнаем их тайны.
    </p>

    <div id="parallax-world-of-ugg" class="bg-white text-black dark:bg-gray-900 dark:text-white">
      <section>
        <div class="title text-center mb-6">
          <h3 class="text-lg text-gray-700 font-sans md:text-xl text-black dark:text-white animate__animated animate__fadeIn">The World of Celebrities:</h3>
          <h1 class="text-2xl font-bold text-black font-sans md:text-4xl dark:text-white animate__animated animate__fadeIn">Мир Знаменитостей:</h1>
        </div>
      </section>
      ...
      <section>
        <div class="parallax-one pt-52 pb-52 overflow-hidden relative w-full bg-cover bg-center" style="background-image: url('https://s.yimg.com/ny/api/res/1.2/C1VtvnjNU3wGs7Q97BMQLw--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyNDI7aD04Mjg-/https://media.zenfs.com/en/footwear_news_642/42d7f5899c3c17bc0e89e45b5dfa675b');">
          <h2 class="text-white text-7xl text-center font-sans animate__animated animate__fadeIn">ВДОХНОВЕНИЕ, ТАЛАНТЫ И КУЛЬТУРЫ СОВРЕМЕННОСТИ</h2>
        </div>
      </section>

      <section>
        <div class="block bg-white dark:bg-gray-900 p-16 mx-auto text-justify w-3/4 animate__animated animate__fadeIn">
          ...
          <div class="border-b border-black dark:border-white w-36 mx-auto my-10"></div>
      ...
      <section>
        <div class="parallax-two pt-52 pb-52 overflow-hidden relative w-full bg-cover bg-center" style="background-image: url('https://s.yimg.com/ny/api/res/1.2/1DjH9fNGSgMRiFJpXtDD7A--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyMDA7aD03OTQ-/https://media.zenfs.com/en/billboard_547/70f5b9c53a2a63c45a18193c57763a50');">
          <h2 class="text-white text-7xl text-center font-sans animate__animated animate__fadeIn">2025</h2>
        </div>
      </section>

      <section>
        <div class="block p-16 mx-auto text-justify w-3/4 animate__animated animate__fadeIn">
      ...
      <section>
        <div class="parallax-three pt-52 pb-52 overflow-hidden relative w-full bg-cover bg-center" style="background-image: url('https://s.yimg.com/ny/api/res/1.2/._S8VNN48BQRjsaAarh47g--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyMDA7aD02NzU-/https://media.zenfs.com/en/pc_gamer_708/8115377410ab0cb2e0f4fbdb5a770f57');">
          <h2 class="text-white text-7xl text-center font-sans animate__animated animate__fadeIn">НОВЫЕ ТРЕНДЫ</h2>
        </div>
      </section>
      ...
      <section>
        <div class="parallax-four pt-52 pb-52 overflow-hidden relative w-full bg-cover bg-center" style="background-image: url('https://vkplay.ru/pre_0x736_resize/hotbox/content_files/Stories/2024/05/15/325f5b39bbfb430ab5fa279b6055f6b0.jpg?quality=85');">
          <h2 class="text-white text-7xl text-center font-sans animate__animated animate__fadeIn">АКТЕРЫ: ИССКУСТВО ПОЛИПТИХА</h2>
        </div>
      </section>
      ...
      <section>
        <div class="parallax-five pt-52 pb-52 overflow-hidden relative w-full bg-cover bg-center" style="background-image: url('https://dropi.ru/img/uploads/2017-12-27/3_original.jpeg');">
          <h2 class="text-white text-7xl text-center font-sans animate__animated animate__fadeIn">ЗАКЛЮЧЕНИЕ: ВДОХНОВЕНИЕ И ВОЗМОЖНОСТИ</h2>
        </div>
      </section>
...
const loadMore = () => {
  const nextPosts = posts.slice(displayedPosts.value.length, displayedPosts.value.length + 1);
  displayedPosts.value = displayedPosts.value.concat(nextPosts);
};
</script>
